...
import ProfileThoughts from '../components/ProfileThoughts';
...
class ProfileComponent extends React.Component
{
    ...
    componentWillMount(){
        try{
            let username =  this.props.loginStatus;
            axios.get('https://backendtrends.herokuapp.com/exercises/personal/'+username)
            .then(response => {
    ...
    componentDidMount()
    {
        ...
        .then(response => {
            ...
            {
                if(detail.username == this.props.loginStatus)
                {
    ...
    printThoughts()
    {
        let arrayofCards = []
            ...
            {
                arrayofCards.push(<ProfileThoughts Tags = {d}></ProfileThoughts>)
            }
            return arrayofCards;
    }
    render()
